...
x_training_dataset = np.asarray([i[:14, 14:].tolist() for i in x_training_dataset])
x_testing_dataset = np.asarray([i[:14, 14:].tolist() for i in x_testing_dataset])
...
trained_model.save('saved_model/my_model3')